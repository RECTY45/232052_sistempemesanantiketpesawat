                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p class="mb-0">Pemesanan Menunggu</p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p class="mb-0">Pemesanan Dikonfirmasi</p>
                            </div>
                            <div>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div>
                                <a href="{{ route('customer.search-flights') }}" class="btn btn-light btn-sm">Pesan
                                    Sekarang</a>
                                <p class="mb-0 mt-2">Pemesanan Cepat</p>
                            </div>
                            <div>
                                    ...
                                    <tbody>
                                        @foreach($recentBookings as $booking)
                                            <tr>
                                                ...
                                                <td>{{ $booking->flight->departure_airport->city }} →
                                                    {{ $booking->flight->arrival_airport->city }}</td>
