          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center mb-3">
              <span class="app-brand-logo demo">
                <img src="{{ asset('img/favicon/travelo-logo.svg') }}" alt="Travelo Logo" class="block mx-auto pb-2"
                  style="width: 170px; height: auto;">
              </span>
            </div>
            <!-- /Logo -->

            <h4 class="mb-1 text-center">Selamat Datang di {{ $name }} ‹</h4>
            <p class="mb-4 text-center">Silakan masuk ke akun Anda dan mulai petualangan</p>
