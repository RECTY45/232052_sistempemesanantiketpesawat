                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('timezone') is-invalid @enderror" id="timezone"
                                        ...
                                        <option value="WIB" {{ old('timezone', 'WIB') == 'WIB' ? 'selected' : '' }}>WIB
                                            (UTC+7)</option>
                                        <option value="WITA" {{ old('timezone') == 'WITA' ? 'selected' : '' }}>WITA (UTC+8)
                                        </option>
                                        <option value="WIT" {{ old('timezone') == 'WIT' ? 'selected' : '' }}>WIT (UTC+9)
                                        </option>
                                    </select>
                                    @error('timezone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('international') is-invalid @enderror"
                                        ...
                                        <option value="0" {{ old('international', '0') == '0' ? 'selected' : '' }}>Domestik
                                        </option>
                                        <option value="1" {{ old('international') == '1' ? 'selected' : '' }}>Internasional
                                        </option>
                                    </select>
                                    @error('international')
                                        <div class="invalid-feedback">{{ $message }}</div>
