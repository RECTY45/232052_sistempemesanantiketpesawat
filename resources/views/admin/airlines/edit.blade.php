        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h4 class="fw-bold py-3 mb-1">
                    <span class="text-muted fw-light">Master Data / Maskapai /</span> Edit {{ $airline->name }}
                </h4>
                <p class="text-muted">Edit informasi maskapai penerbangan</p>
            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('country') is-invalid @enderror" id="country"
                                    ...
                                    <option value="Indonesia" {{ old('country', $airline->country) == 'Indonesia' ? 'selected' : '' }}>Indonesia
                                    </option>
                                    <option value="Malaysia" {{ old('country', $airline->country) == 'Malaysia' ? 'selected' : '' }}>Malaysia
                                    </option>
                                    <option value="Singapore" {{ old('country', $airline->country) == 'Singapore' ? 'selected' : '' }}>Singapore
                                    </option>
                                    <option value="Thailand" {{ old('country', $airline->country) == 'Thailand' ? 'selected' : '' }}>Thailand
                                    </option>
                                    <option value="Philippines" {{ old('country', $airline->country) == 'Philippines' ? 'selected' : '' }}>
                                        Philippines</option>
                                    <option value="Vietnam" {{ old('country', $airline->country) == 'Vietnam' ? 'selected' : '' }}>Vietnam
                                    </option>
                                </select>
                                @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description"
                                    ...
                                    placeholder="Masukkan deskripsi maskapai...">{{ old('description', $airline->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                        value="1" {{ old('is_active', $airline->is_active) ? 'checked' : '' }}>
